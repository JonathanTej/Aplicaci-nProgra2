...
namespace AplicaciónProgra2.NorthwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AplicaciónProgra2.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        public virtual int FillBy(NorthwindDataSet.CustomersDataTable dataTable) {
